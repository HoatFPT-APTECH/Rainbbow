...
---------------------------- */
        ...
        $(document).ready(function () {
            $(
                ".prs_about_pre_right_slider_sec_wrapper .owl-carousel"
            ).owlCarousel({
                loop: true,
                margin: 10,
                autoplay: true,
        ...
        $(".test-popup-link").magnificPopup({
            ...
            callbacks: {
                beforeOpen: function() {
                    var $triggerElement = $(this.st.el); // Lấy phần tử liên kết được nhấp vào
                    var href = $triggerElement.attr("href"); // Lấy giá trị href
                      console.log(href)
                    // Đặt giá trị src cho iframe
                    this.st.iframe.src = href;
                }
            }
            // other options
        });
