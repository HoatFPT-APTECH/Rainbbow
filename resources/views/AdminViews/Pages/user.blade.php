            ...
            <table class="table table-striped table-hover table-bordered">
                ...
                <tbody>
                 ...
                 <tr>
                     ...
                     <td>
                        <a href="/admin/user/{{$User->Id}}" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                        <a href="/admin/user/{{$User->Id}}/edit" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                        <a href="/admin/user/delete/{{$User->Id}}" onclick="return confirm('Your sure delete performer has name: {{$User->UserName}}')" class="delete?id=" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                    </td>
