								...
								<div class="row">
									...
									<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
										<div class="st_md_ts_main_sec float_left">
											<img src="{{$assetPathRainbow}}/images/content/md1.png" alt="img">
									...
									<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
										<div class="st_md_ts_main_sec float_left">
											<img src="{{$assetPathRainbow}}/images/content/md2.png" alt="img">
									...
									<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
										<div class="st_md_ts_main_sec float_left">
											<img src="{{$assetPathRainbow}}/images/content/md3.png" alt="img">
													...
													<div class="owl-carousel owl-theme">
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="{{$assetPathRainbow}}/images/content/c1.jpg" alt="img">
														...
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="{{$assetPathRainbow}}/images/content/c2.jpg" alt="img">
														...
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="{{$assetPathRainbow}}/images/content/c3.jpg" alt="img">
														...
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="{{$assetPathRainbow}}/images/content/c4.jpg" alt="img">
											...
											<div class="col-md-12">
												<div class="st_md_summ_client_slider float_left">
													...
													<div class="owl-carousel owl-theme">
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="{{$assetPathRainbow}}/images/content/c5.jpg" alt="img">
														...
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="{{$assetPathRainbow}}/images/content/c6.jpg" alt="img">
														...
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="{{$assetPathRainbow}}/images/content/c7.jpg" alt="img">
														...
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="{{$assetPathRainbow}}/images/content/c8.jpg" alt="img">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="st_ind_sidebar_advertiz st_ind_sidebar_advertiz_md float_left">
									<a href="#">
										<img src="{{$assetPathRainbow}}/images/index_III/add.png" alt="img">
									</a>
								</div>
							</div>
							<div class="col-md-12">
