				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="prs_mc_slider_wrapper">
						<div class="owl-carousel owl-theme">
							<div class="item">
								<img src="{{$assetPathRainbow}}/images/content/movie_category/slider_img1.jpg" alt="about_img">
							</div>
							<div class="item">
								<img src="{{$assetPathRainbow}}/images/content/movie_category/slider_img2.jpg" alt="about_img">
							</div>
							<div class="item">
								<img src="{{$assetPathRainbow}}/images/content/movie_category/slider_img3.jpg" alt="about_img">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 hidden-sm hidden-xs">
					...
					<form action="/rainbow/search" method="get" >
						...
						<div class="prs_mcc_bro_title_wrapper">
							...
							<ul>
								<li>
									<i class="fa fa-caret-right"></i> &nbsp;&nbsp;&nbsp;<a href="/rainbow/movie_category" >All <span></span></a> 
								</li>
								@foreach($listMovieCategory as $mc )
								<li><i class="fa fa-caret-right"></i> &nbsp;&nbsp;&nbsp;<a href="/rainbow/search?category={{$mc->Id}}">{{$mc->Name}} <span> {{sizeof($mc->movies)}} </span></a> 
								</li>
								@endforeach
									...
									<div id="list" class="tab-pane fade">
										<div class="row">
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="prs_mcc_list_movie_main_wrapper">
													<div class="prs_mcc_list_movie_img_wrapper">
														<img src="{{$assetPathRainbow}}/images/content/movie_category/up1.jpg" alt="categoty_img">
													</div>
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="prs_mcc_list_movie_main_wrapper">
													<div class="prs_mcc_list_movie_img_wrapper">
														<img src="{{$assetPathRainbow}}/images/content/movie_category/up2.jpg" alt="categoty_img">
													</div>
													<div class="prs_mcc_list_movie_img_cont_wrapper">
														<div class="prs_mcc_list_left_cont_wrapper">
															<h2>Busting Car</h2>
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="prs_mcc_list_movie_main_wrapper">
													<div class="prs_mcc_list_movie_img_wrapper">
														<img src="{{$assetPathRainbow}}/images/content/movie_category/up3.jpg" alt="categoty_img">
													</div>
													<div class="prs_mcc_list_movie_img_cont_wrapper">
														<div class="prs_mcc_list_left_cont_wrapper">
															<h2>Busting Car</h2>
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="prs_mcc_list_movie_main_wrapper">
													<div class="prs_mcc_list_movie_img_wrapper">
														<img src="{{$assetPathRainbow}}/images/content/movie_category/up4.jpg" alt="categoty_img">
													</div>
													<div class="prs_mcc_list_movie_img_cont_wrapper">
														<div class="prs_mcc_list_left_cont_wrapper">
															<h2>Busting Car</h2>
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="prs_mcc_list_movie_main_wrapper">
													<div class="prs_mcc_list_movie_img_wrapper">
														<img src="{{$assetPathRainbow}}/images/content/movie_category/up5.jpg" alt="categoty_img">
													</div>
													<div class="prs_mcc_list_movie_img_cont_wrapper">
														<div class="prs_mcc_list_left_cont_wrapper">
															<h2>Busting Car</h2>
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="prs_mcc_list_movie_main_wrapper">
													<div class="prs_mcc_list_movie_img_wrapper">
														<img src="{{$assetPathRainbow}}/images/content/movie_category/up6.jpg" alt="categoty_img">
													</div>
													<div class="prs_mcc_list_movie_img_cont_wrapper">
														<div class="prs_mcc_list_left_cont_wrapper">
															<h2>Busting Car</h2>
