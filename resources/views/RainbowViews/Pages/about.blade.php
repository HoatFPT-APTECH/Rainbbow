				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="prs_about_pre_left_sec_wrapper">
						<div class="prs_ap_left_img_wrapper">
							<img src="{{$assetPathRainbow}}/images/content/about/ap1.jpg" alt="about_img">
						</div>
					...
					<div class="prs_about_pre_right_sec_wrapper">
						<div class="prs_about_pre_right_slider_sec_wrapper">
							<div class="owl-carousel owl-theme">
								<div class="item">
									<img src="{{$assetPathRainbow}}/images/content/about/ap2.jpg" alt="about_img">
								</div>
								<div class="item">
									<img src="{{$assetPathRainbow}}/images/content/about/ap2.jpg" alt="about_img">
								</div>
				...
				<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
					<div class="prs_about_team_first_mem_wrapper">
						<div class="prs_about_first_mem_img_wrapper">
							<img src="{{$assetPathRainbow}}/images/content/about/tm1.jpg" alt="team_img">
					...
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 prs_ap_colum_full">
							<div class="prs_about_team_first_mem_wrapper prs_about_team_first_mem_wrapper2_inner">
								<div class="prs_about_first_mem_img_wrapper">
									<img src="{{$assetPathRainbow}}/images/content/about/tm2.jpg" alt="team_img">
						...
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 prs_ap_colum_full">
							<div class="prs_about_team_first_mem_wrapper prs_about_team_first_mem_wrapper2_inner">
								<div class="prs_about_first_mem_img_wrapper">
									<img src="{{$assetPathRainbow}}/images/content/about/tm3.jpg" alt="team_img">
									<div class="prs_at_social_main_wrapper prs_at_social_inner_main_wrapper">
										<ul>
											<li><a href="#"><i class="fa fa-facebook"></i></a>
											</li>
						...
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 prs_ap_colum_full">
							<div class="prs_about_team_first_mem_wrapper prs_about_team_first_mem_wrapper2_inner">
								<div class="prs_about_first_mem_img_wrapper">
									<img src="{{$assetPathRainbow}}/images/content/about/tm4.jpg" alt="team_img">
									<div class="prs_at_social_main_wrapper prs_at_social_inner_main_wrapper">
										<ul>
											<li><a href="#"><i class="fa fa-facebook"></i></a>
											</li>
						...
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 prs_ap_colum_full">
							<div class="prs_about_team_first_mem_wrapper prs_about_team_first_mem_wrapper2">
								<div class="prs_about_first_mem_img_wrapper">
									<img src="{{$assetPathRainbow}}/images/content/about/tm5.jpg" alt="team_img">
									<div class="prs_at_social_main_wrapper prs_at_social_inner_main_wrapper">
										<ul>
											<li><a href="#"><i class="fa fa-facebook"></i></a>
											</li>
						...
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 prs_ap_colum_full">
							<div class="prs_about_team_first_mem_wrapper prs_about_team_first_mem_wrapper2">
								<div class="prs_about_first_mem_img_wrapper">
									<img src="{{$assetPathRainbow}}/images/content/about/tm6.jpg" alt="team_img">
									<div class="prs_at_social_main_wrapper prs_at_social_inner_main_wrapper">
										<ul>
											<li><a href="#"><i class="fa fa-facebook"></i></a>
											</li>
						...
						<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 prs_ap_colum_full">
							<div class="prs_about_team_first_mem_wrapper prs_about_team_first_mem_wrapper2">
								<div class="prs_about_first_mem_img_wrapper">
									<img src="{{$assetPathRainbow}}/images/content/about/tm7.jpg" alt="team_img">
									<div class="prs_at_social_main_wrapper prs_at_social_inner_main_wrapper">
										<ul>
											<li><a href="#"><i class="fa fa-facebook"></i></a>
											</li>
