								...
								<div class="hs_blog_box1_main_wrapper hs_blog_box2_main_wrapper">
									<div class="hs_blog_box1_img_wrapper">
										<div class="owl-carousel owl-theme">
											...
											<div class="item">
												<img src="{{$assetPathRainbow}}/images/content/blog_category/b2.jpg" alt="blog_img">
											</div>
											<div class="item">
												<img src="{{$assetPathRainbow}}/images/content/blog_category/b3.jpg" alt="blog_img">
											</div>
										</div>
									</div>
									<div class="hs_blog_box1_cont_main_wrapper">
...
the meaningful</h2>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="hs_blog_box1_main_wrapper hs_blog_box2_main_wrapper">
									<div class="hs_blog_box1_img_wrapper">
										<iframe src="{{$assetPathRainbow}}/https://www.youtube.com/embed/tqYDVMTjAzY"></iframe>
									</div>
									<div class="hs_blog_box1_cont_main_wrapper">
										<div class="hs_blog_cont_heading_wrapper">
											<ul>
