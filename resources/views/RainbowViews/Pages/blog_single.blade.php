							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="hs_blog_box1_main_wrapper">
									<div class="hs_blog_box1_img_wrapper">
										<img src="{{$assetPathRainbow}}/images/content/blog_category/b1.jpg" alt="blog_img">
									</div>
...
the meaningful</h2>
											...
											<div class="row">
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
													<div class="prs_bs_three_img">
														<img src="{{$assetPathRainbow}}/images/content/blog_category/bs1.jpg" alt="blog_img">
													</div>
												</div>
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
													<div class="prs_bs_three_img">
														<img src="{{$assetPathRainbow}}/images/content/blog_category/bs2.jpg" alt="blog_img">
													</div>
												</div>
												<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
													<div class="prs_bs_three_img">
														<img src="{{$assetPathRainbow}}/images/content/blog_category/bs3.jpg" alt="blog_img">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="prs_bs_admin_section_wrapper">
											...
											<div class="prs_bs_admin_img_cont_wrapper">
												<img src="{{$assetPathRainbow}}/images/content/blog_category/bs4.jpg" alt="blog_img">
											</div>
										</div>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="prs_bs_about_admin_main_wrapper">
									<div class="prs_bs_about_img_wrapper">
										<img src="{{$assetPathRainbow}}/images/content/blog_category/bs5.jpg" alt="blog_img">
									</div>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="hs_rs_comment_main_wrapper hs_rs_comment_main_wrapper2">
									<div class="hs_rs_comment_img_wrapper">
										<img src="{{$assetPathRainbow}}/images/content/blog_category/comm_img1.jpg" alt="comment_img">
									</div>
									<div class="hs_rs_comment_img_cont_wrapper hs_rs_blog_single_comment_img_cont_wrapper">
										<h2>Joahn Doe<br> <span>Jan 2 , 2022 - Friday</span> <a href="#"> - Reply</a></h2>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="hs_rs_comment_main_wrapper">
									<div class="hs_rs_comment_img_wrapper">
										<img src="{{$assetPathRainbow}}/images/content/blog_category/comm_img2.jpg" alt="comment_img">
									</div>
									<div class="hs_rs_comment_img_cont_wrapper hs_rs_blog_single_comment_img_cont_wrapper">
										<h2>Joahn Doe<br> <span>Jan 2 , 2022 - Friday</span> <a href="#"> - Reply</a></h2>
										<p>The actor, director and producer, son to well-known stunt choreographer of Bollywood, rried to one of the most vivacious, bubbly, live-wire actress, is none other than our dashing Ajay Devgan, originally named Vishal Devgan !</p>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="hs_rs_comment_main_wrapper">
									<div class="hs_rs_comment_img_wrapper">
										<img src="{{$assetPathRainbow}}/images/content/blog_category/comm_img3.jpg" alt="comment_img">
									</div>
									<div class="hs_rs_comment_img_cont_wrapper hs_rs_blog_single_comment_img_cont_wrapper">
										<h2>Joahn Doe<br> <span>Jan 2 , 2022 - Friday</span> <a href="#"> - Reply</a></h2>
										<p>The actor, director and producer, son to well-known stunt choreographer of Bollywood, rried to one of the most vivacious, bubbly, live-wire actress, is none other than our dashing Ajay Devgan, originally named Vishal Devgan !</p>
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="hs_blog_right_sidebar_main_wrapper">
						...
						<div class="prs_bc_right_about_wrapper">
							<img src="{{$assetPathRainbow}}/images/content/blog_category/side_img1.jpg" alt="side_img">
						...
						<div class="prs_mcc_bro_title_wrapper">
							...
							<div class="hs_blog_right_recnt_cont_wrapper">
								<div class="hs_footer_ln_img_wrapper">
									<img src="{{$assetPathRainbow}}/images/content/blog_category/n1.jpg" alt="ln_img" />
								</div>
...
menus.</h4>
							...
							<div class="hs_blog_right_recnt_cont_wrapper hs_blog_right_recnt_cont_wrapper2">
								<div class="hs_footer_ln_img_wrapper">
									<img src="{{$assetPathRainbow}}/images/content/blog_category/n2.jpg" alt="ln_img" />
								</div>
								<div class="hs_footer_ln_cont_wrapper">
									<h4>Lorem spum
menus.</h4>
							...
							<div class="hs_blog_right_recnt_cont_wrapper hs_blog_right_recnt_cont_wrapper2">
								<div class="hs_footer_ln_img_wrapper">
									<img src="{{$assetPathRainbow}}/images/content/blog_category/n3.jpg" alt="ln_img" />
								</div>
								<div class="hs_footer_ln_cont_wrapper">
									<h4>Lorem spum
menus.</h4>
