...
<div class="prs_navigation_main_wrapper">
    <div class="container-fluid">
                ...
                <nav class="navbar navbar-default">
                    <div id="dl-menu" class="xv-menuwrapper responsive-menu">
                        ...
                        <ul class="dl-menu">
                            ...
                            <li class="parent"><a href="/rainbow/cinemamovie">Cinema</a>
        ...
        <div id="mobile-nav" data-prevent-default="true" data-mouse-events="true">
            <style>
                #mobile-nav {
                    background-image: linear-gradient(to right, #431d4d, #cc79a6);
                }
              </style>
            ...
            <div class="mobile-nav-box">
                ...
                <ul class="mobile-list-nav">
                    <li><a href="/rainbow//about"><b style="color: rgb(254, 253, 253);">HOME</b></a>
                    </li>
                    <li><a href="/rainbow//movie_single"><b style="color: rgb(254, 253, 253);">MOVIE</b></a>
                    </li>
                    <li><a href="/rainbow/event_single"><b style="color: rgb(254, 253, 253);">CINEMA</b></a>
                    </li>
                    <li><a href="/rainbow/gallery"><b style="color: rgb(254, 253, 253);">VIDEO</b></a>
                   
                    <li><a href="/rainbow/contact"><b style="color: rgb(254, 253, 253);">CONTACT</b></a>
                    </li>
                </ul>
                ...
                <div class="prs_top_login_btn_wrapper prs_slidebar_searchbar_btn_wrapper">
                    <div class="prs_animate_btn1">
                        <ul>
                            <li><br><a href="/rainbow/#" class="button button--tamaya" data-text="log in "
