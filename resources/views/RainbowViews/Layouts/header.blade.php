...
<div id="preloader">
		<div id="status">
			<img src="https://media1.giphy.com/media/xTk9ZvMnbIiIew7IpW/giphy.gif?cid=ecf05e47k1quylzlzv9mcxbb4ntjil4vb1njx1s2bnug3qi0&ep=v1_gifs_related&rid=giphy.gif&ct=g" id="preloader_image" alt="loader">
		</div>
	</div>
	<!-- color picker start -->
							...
							<ul class="dl-menu">
								...
								<li class="parent megamenu"><a href="/rainbow/#">movie</a>
									<ul class="lg-submenu">
										<li><a>Popular Hindi Movies</a>
											<ul class="lg-submenu">
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Bajiro Mastani</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Drishyam</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Queen</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Wanted</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Veer</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Jannat</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Baaghi</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Baaghi-2</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Ki & Ka</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Kahaani</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Jab We Met</a>
												</li>
											</ul>
										</li>
										<li><a>Popular Kannada Movies</a>
											<ul class="lg-submenu">
												...
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Kirik Party</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Mahakali</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">karvva</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Ishtakamya</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Jigarthanda</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Abhimani</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Priyanka</a>
												</li>
											</ul>
										</li>
										<li><a>Popular Bengali Movies</a>
											<ul class="lg-submenu">
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Baro Bou</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Tomake</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Jeevan</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Haraner </a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Bidhilipi</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Bhalobasa </a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Prateek</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Aparanher</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Mukhyamantri</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Charmurti</a>
												</li>
											</ul>
										</li>
										<li><a>Popular Hollywood Movies</a>
											<ul class="lg-submenu">
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Wind River</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Logan</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Coco</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Meyerowitz </a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Ragnarok</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Driver</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Dunkirk</a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Big Sick </a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">American </a>
												</li>
												<li class="ar_left"><i class="fa fa-film"></i><a href="/rainbow/#">Logan </a>
												</li>
											</ul>
										...
										<li>
											<div class="prs_navi_slider_wraper">
												<div class="owl-carousel owl-theme">
													<div class="item">
														<img src="{{$assetPathRainbow}}/images/content/up1.jpg" alt="navi_img">
													</div>
													<div class="item">
														<img src="{{$assetPathRainbow}}/images/content/up2.jpg" alt="navi_img">
													</div>
													<div class="item">
														<img src="{{$assetPathRainbow}}/images/content/up3.jpg" alt="navi_img">
													</div>
												</div>
											</div>
										</li>
								...
								<li class="parent megamenu"><a href="/rainbow/#">video</a>
									<ul class="lg-submenu prs_navi_video_wrapper">
										...
										<li class="hidden-sm">
											<div class="prs_video_navi_img_main_wrapper">
												<img src="{{$assetPathRainbow}}/images/content/vp6.jpg" alt="video_img">
												<div class="prs_video_navi_overlay_wrapper"> <a class="test-popup-link button" rel='external' href='https://www.youtube.com/embed/ryzOXAO0Ss0' title='title'><i class="flaticon-play-button"></i></a>
												</div>
											</div>
										</li>
			...
			<div class="prs_navi_right_main_wrapper">
				...
				<div class="prs_top_login_btn_wrapper">
					<div class="prs_animate_btn1">
						<ul>
							<li><a href="/rainbow/#" class="button button--tamaya" data-text="sign up" data-toggle="modal" data-target="#myModal"><span>sign up</span></a>
							</li>
						</ul>
					</div>
				</div>
