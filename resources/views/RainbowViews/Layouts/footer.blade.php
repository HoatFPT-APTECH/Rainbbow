 ...
 <div class="modal fade st_pop_form_wrapper" id="myModal" role="dialog">
	@include("RainbowViews.Component.LoginForm")
 ...
 <script src="{{ $assetPathRainbow }}/js/owl.carousel.js"></script>
 <script src="{{ $assetPathRainbow }}/js/jquery.dlmenu.js"></script>
 <script src="{{ $assetPathRainbow }}/js/jquery.sticky.js"></script>
 <script src="{{ $assetPathRainbow }}/js/jquery.nice-select.min.js"></script>
 <script src="{{ $assetPathRainbow }}/js/jquery.magnific-popup.js"></script>
 <script src="{{ $assetPathRainbow }}/js/jquery.bxslider.min.js"></script>
 <script src="{{ $assetPathRainbow }}/js/venobox.min.js"></script>
 <script src="{{ $assetPathRainbow }}/js/smothscroll_part1.js"></script>
 <script src="{{ $assetPathRainbow }}/js/smothscroll_part2.js"></script>
 <script src="{{ $assetPathRainbow }}/js/plugin/rs_slider/jquery.themepunch.revolution.min.js"></script>
 <script src="{{ $assetPathRainbow }}/js/plugin/rs_slider/jquery.themepunch.tools.min.js"></script>
 <script src="{{ $assetPathRainbow }}/js/plugin/rs_slider/revolution.addon.snow.min.js"></script>
 <script src="{{ $assetPathRainbow }}/js/plugin/rs_slider/revolution.extension.actions.min.js"></script>
 <script src="{{ $assetPathRainbow }}/js/plugin/rs_slider/revolution.extension.carousel.min.js"></script>
 <script src="{{ $assetPathRainbow }}/js/plugin/rs_slider/revolution.extension.kenburn.min.js"></script>
 <script src="{{ $assetPathRainbow }}/js/plugin/rs_slider/revolution.extension.layeranimation.min.js"></script>
 <script src="{{ $assetPathRainbow }}/js/plugin/rs_slider/revolution.extension.migration.min.js"></script>
 <script src="{{ $assetPathRainbow }}/js/plugin/rs_slider/revolution.extension.navigation.min.js"></script>
 <script src="{{ $assetPathRainbow }}/js/plugin/rs_slider/revolution.extension.parallax.min.js"></script>
